...
import math
from models.archs.arch_util import EventImage_ChannelAttentionTransformerBlock #basicsr.
...
class EFNet(nn.Module):
    def __init__(self, in_chn=3, ev_chn=6, wf=64, depth=3, fuse_before_downsample=True, relu_slope=0.2, num_heads=[1,2,4]):
        ...
        self.cat12 = nn.Conv2d(prev_channels*3, prev_channels, 1, 1, 0) #changed here 2 to 3
    ...
    def forward(self, x, event, mask=None):
        ...
        #print("e1, x1", e1_clone.size(), x1_clone.size())
        output_fcfe = self.fcfe(e1_clone, x1_clone) # added here
        #print("output", output_fcfe.size())
        ...
        #print("sam_feature", sam_feature.size())
