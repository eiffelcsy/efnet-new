...
class EFNet_att_multiscale_track_fusion(nn.Module):
    def __init__(
        self,
        in_chn=3,
        ev_chn=6,
        ...
        super(EFNet_att_multiscale_track_fusion, self).__init__()
        self.depth = depth
        ...
        for i in range(depth):
            ...
            layer_use_tracking = use_tracking and use_multiscale_tracking
    ...
    def reset_lstm_states(self):
        for i in range(self.depth):  # Only reset first two layers where tracking is used
...
if __name__ == "__main__":
    ...
    model = EFNet_att_multiscale_track_fusion()
